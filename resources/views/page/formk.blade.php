        ...
        <div class="card-body">
            ...
            <form action="{{ empty($info->id) ? url('/page') : url('/page/' . $info->id) }}" method="post">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        document.getElementById('attachdorder_date').addEventListener('change', function() {
                            const dateValue = this.value;
                            document.getElementById('attachdorder_date_display').value = dateValue ? formatDate(
                                dateValue) : '';
                        });
                    });
                </script>
            ...
            <div class="product-entry mb-3 d-flex">
                ...
                <div class="mb-2 me-2" style="flex-basis: 150px;">
                    <label for="products[${index}][unit]" class="form-label">หน่วย</label>
                    <input type="text" class="form-control" id="products[${index}][unit]"
                        name="products[${index}][unit]" placeholder="หน่วย">
                </div>
                <div class="mb-2" style="flex-basis: 150px;">
                    <label for="products[${index}][product_price]" class="form-label">ราคาผลิตภัณฑ์</label>
                    <input type="text" class="form-control product-price" id="products[${index}][product_price]"
                        name="products[${index}][product_price]" placeholder="ราคาผลิตภัณฑ์">
                </div>
            </div>
        `;
