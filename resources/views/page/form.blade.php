...
@section('info')
    ...
    <div class="card">
        <div class="card-body">
            <h2 class="card-header ">เอกสารจัดซื้อจัดจ้างวงเงินไม่เกิน 1 แสน</h2>
                        ...
                        <div id="inspectors-container">
                            ...
                            @if (!isset($info->id))
                                <div class="inspector-entry mb-3 d-flex flex-wrap">
                                    <div class="flex-fill mb-2 me-2">
                                        <label for="inspectors[${index}][inspector_name]"
                                            class="form-label">ชื่อผู้ตรวจสอบ</label>
                                        <input type="text" class="form-control"
                                            id="inspectors[${index}][inspector_name]"
                                            name="inspectors[${index}][inspector_name]" placeholder="ชื่อผู้ตรวจสอบ">
                                    </div>
                                    <div class="flex-fill mb-2 me-2">
                                        <label for="inspectors[${index}][inspector_position]"
                                            class="form-label">ตำแหน่ง</label>
                                        <input type="text" class="form-control"
                                            id="inspectors[${index}][inspector_position]"
                                            name="inspectors[${index}][inspector_position]" placeholder="ตำแหน่ง">
                                    </div>
                                </div>
                            @endif
                        </div>
