...
@section('title', 'Confirm PDF Generation')

@section('info')
    <div class="card">
        <div class="card-body">
            <h1>Convert PDF Generation</h1>
            <form action="{{ route('page.confirmPdf', $info->id) }}" method="POST">
                @csrf
                <p>คุณแน่ใจหรือไม่ว่าต้องการสร้าง PDF สำหรับรายละเอียดต่อไปนี้?</p>
                <ul>
                    ...
                    <li><strong>เอกต้องทำถึง:</strong> {{ $info->attachdorder }}</li>
